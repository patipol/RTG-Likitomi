...
+---------------------*/
 ...
 |
 */
 $config['FAL_website_name']    = "Likitomi";
 ...
 |
 */
 $config['FAL_user_support'] = 'sanjil@ait.ac.th';
 ...
 */
 ...
 |
 */
 $config['FAL_denied_from_ext_location'] = 'deniedlocation';
 ...
 */
 ...
 //Added
 $config['FAL_admin_uri'] = 'admin/admins'; 
/*------------------+
|  TEMPLATE SETTINGS|
+------------------*/
...
$config['FAL_captcha_use_numbers'] = TRUE;

// use special characters (if true, use a font that support it)
$config['FAL_captcha_use_specials'] = FALSE;

$config['FAL_captcha_min'] = 6;      //min captcha length
$config['FAL_captcha_max'] = 6;      //max captcha length
...
+----------------*/
 ...
 |
 */
 $config['FAL_template_dir'] = 'authenticate/';
 ...
 |
 */
 $config['FAL_denied_page'] = $config['FAL_template_dir'].'template/denied';
/*--------------------------+
|  E-MAIL CONTENT SETTINGS  |
+--------------------------*/

 $config['FAL_email_from'] = 'Likitomi Webmaster';
