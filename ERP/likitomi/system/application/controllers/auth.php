...
{	
    ...
    {	    	
		...
		{
			if(preg_match('/firefox/i',$this->agent->browser())) $firefoxcheck =true;
			else if(preg_match('/mozilla/i',$this->agent->browser())) $firefoxcheck =true;
			else $firefoxcheck =false;
		}
		if($firefoxcheck){
			...
			echo "Current browser is :" . $this->agent->browser()." ".$this->agent->version();
			echo "<h1> ".$this->lang->line('download_firefox')."</h1><br/>";
			echo '<a href="http://www.getfirefox.net/download.html"><img border="0" alt="Firefox 3" title="Firefox 3" src="http://sfx-images.mozilla.org/affiliates/Buttons/firefox3/FF3b80x15_square.gif"/></a>';
		} 
    }
